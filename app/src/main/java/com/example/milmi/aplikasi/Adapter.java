...
public class Adapter extends RecyclerView.Adapter<Adapter.AppViewHolder> {
    ...
    @NonNull
    @Override
    public Adapter.AppViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter.AppViewHolder holder, int position) {
